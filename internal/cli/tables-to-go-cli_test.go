	...
	tests := []struct {
		...
		},
		{
			...
			settings: func() *settings.Settings {
				s := settings.New()
				s.GenHeader = true
				s.GeneratorVersion = "v2.12.2"
				return s
			}(),
			expected: "// Code generated by tables-to-go. DO NOT EDIT.\n// versions:\n// \ttables-to-go v2.12.2\n// source: test_table\n\npackage dto\n\ntype TestTable struct {\nColumnName string `db:\"column_name\"`\n}",
		},
		{
			desc: "string column with generated header and empty version",
			columnType: func(db database.Database) []string {
				return db.GetStringDatatypes()
			},
			tableComment:  "",
		...
		{
			desc: "string column with generated header and control characters in table name",
			columnType: func(db database.Database) []string {
				return db.GetStringDatatypes()
			},
